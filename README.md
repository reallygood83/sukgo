...
#### 🎤 Deep 모드 — Socratic 인터랙티브 인터뷰 (v0.0.12+)
...
**두 엔진 — 자동/수동 선택**:
- **codex omx deep-interview** (권장, codex+omx 설치 시) — 검증된 Reference 구현, .omx/specs/ 에 spec 파일 생성
- **sukgo native** (v0.0.13+, 기본 폴백) — codex 없어도 동일 알고리즘. LLM 한 호출 = 한 라운드, JSON 형식으로 점수·gates 추적
